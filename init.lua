-- TODO update using https://github.com/nvim-lua/kickstart.nvim/blob/master/init.lua
local fn = vim.fn
...
vim.api.nvim_set_keymap('n', '<leader>fl', ":lua require('telescope').extensions.live_grep_args.live_grep_args()<CR>",
